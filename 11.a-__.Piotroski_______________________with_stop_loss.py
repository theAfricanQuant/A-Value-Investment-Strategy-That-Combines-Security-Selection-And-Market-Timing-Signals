"""
THIS IS STANDARD PIOTROSKI ALGOROTHM THAT SCREENS VALUE SECURITIES.

1. Piotroski F-Score is a value between 0 - 9 which is used to assess strength of company's financial performance[1]
   ...
   Leverage, Liquidity and Source of Funds
       Drop in Leverage (long-term) ratio (1 point if it is less than 0 in the current year, 0 otherwise);
